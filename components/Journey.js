      ...
      <div className="mx-5 md:mx-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2   space-y-5 lg:grid-cols-4 xl:grid-cols-5  justify-center items-center space-x-8 mt-8">
          <div className="text-center   mt-4 ml-10">
            <div className="w-48 h-48 border-dashed mb-4 border-2  mx-auto  flex items-center justify-center rounded-full">
              <div className="relative w-40 h-40  bg-gray-200 rounded-full items-center">
                <Image
          ...
          <div className="text-center lg:mx-2">
            <div className="w-48 h-48 border-dashed border-2  mx-auto mb-2 flex items-center justify-center  rounded-full">
              <div className="relative w-40 h-40  bg-gray-200 rounded-full items-center">
                <Image
                  className="absolute top-8 left-6"
                  src="design.svg"
