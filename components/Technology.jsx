...
const Technology = () => {
 ...
 2xl:h-[977px]" width={1000} height={100} />
      ...
      <div class=" xl:mb-10 md:mx-20  lg:mx-28 2xl:mx-52 mx-6 md:p-6 bg-card open_sans_display ">
      ...
      <div class="xl:mb-10 md:mx-20 lg:mx-28 2xl:mx-52 p-6 bg-background open_sans_display ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 mb-6 lg:grid-cols-3 gap-4">
          <div class="p-4  xl:pt-6 bg-[#F8F8F8] 2xl:p-8  hover:text-white hover:bg-gradient-to-b from-[#C9784F] via-[#A06A7B] to-[#6C506F] ">
