        ...
        <>
            <div className='mx-auto'>
                <div class="max-w-7xl items-center text-center mx-auto px-2 md:px-10 xl:px-20 2xl:px-10 py-16 md:py-20 lg:pt-28 lg:pb-10 ">
                    <h1 class="text-xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl md:leading-snug xl:leading-normal   font-bold playfair_displays mb-4">Flutter App Development Company Helps <br/>You Build Applications for Multiple Screens!</h1>
...
<div className="absolute z-50  w-screen  -bottom-[54px] md:-bottom-20 lg:-bottom-[92px] xl:-bottom-[107px] bg-[#0062FF] bani  transform -translate-x-1/2">
       <Image
        ...
        />
                ...
                <div class=" max-w-7xl mx-auto my-10 mt-40 open_sans_display px-2 sm:px-10 xl:px-20 ">
                ...
                <div class=" bg-background max-w-7xl mx-auto pt-10 text-foreground px-2 sm:px-10 xl:px-20 ">
                    ...
                    <div class="grid gap-4 md:grid-cols-2 open_sans_display">
                        <div class="p-4 border border-border open_sans_display  cont boxes bg-[#F8F8F8]">
                        ...
                        <div class="p-4 border cont border-border boxes bg-[#F8F8F8]">
                        ...
                        <div class="p-4 cont border border-border  boxes bg-[#F8F8F8]">
                        ...
                        <div class="p-4 border border-border cont  boxes bg-[#F8F8F8]">
                ...
                <div className=' my-16 boxshad open_sans_display p-8'>
                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 xl:px-20 ">
                ...
                <div class="max-w-7xl mx-auto  bg-background text-foreground open-sans_display px-2 sm:px-10 xl:px-20  ">
