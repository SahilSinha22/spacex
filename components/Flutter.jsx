    ...
    return (
        <div className='mx-auto'>
            <div class="max-w-7xl items-center text-center mx-auto px-2 md:px-10 xl:px-20 2xl:px-10 py-16 md:py-20 lg:pt-28 lg:pb-10 ">
                <h1 class="text-xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl leading-loose font-bold playfair_displays mb-4">Flutter App Development Company Helps You Build Applications for Multiple Screens!</h1>
            ...
            <div class="flex flex-wrap justify-center gap-4  px-2 md:px-10 max-w-7xl mx-auto ">
                <video
                    autoPlay
                    muted
                    loop
            ...
            <div class=" max-w-7xl mx-auto my-10 open_sans_display px-2 md:px-10 xl:px-20 ">
