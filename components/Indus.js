...
const Indus = () => {
  return (
    <div className=" max-w-7xl   lg:px-8 py-12">
      ...
      <div className="relative h-auto sm:h-60 md:h-60 lg:h-80  mt-10 mx-10 sm:mx-10 md:mx-20 lg:ml-20 justify-left  grid grid-cols-2  sm:grid-cols-6   md:grid-cols-6 ">
        ...
        <div className=" relative md:h-60 lg:h-80    xl:w-72 lg:hover:h-80 bg-black sm:h-56  dark:bg-zinc-800  hover:w-10 sm:hover:w-16 h-48 md:hover:h-auto md:hover:w-20 lg:hover:w-24 md:w-60 lg:w-64 xl:hover:w-28  w-52  p-2  rounded-lg">
          <div className="  absolute   bottom-1 md:bottom-4  hover:opacity-0 p-4 opacity-100">
        ...
        <div className=" relative mt-1 xl:hover:-left-24 sm:hover:w-52 sm:mt-0 z-10 sm:hover:-left-10 left-0 md:h-60 lg:left-24 lg:h-80 xl:left-20 xl:hover:w-72 lg:hover:h-80 md:left-32 sm:left-[94px] bg-black sm:h-56  dark:bg-zinc-800 hover:w-52 w-10 sm:w-16 h-48 md:hover:h-auto md:w-16 lg:w-24 xl:w-28 md:hover:w-60 lg:hover:w-64   p-2  rounded-lg">
