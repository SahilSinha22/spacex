          ...
          <div className="border-b flex   flex-col sm:flex-row items-center m-auto  md:mx-4 ">
            ...
            <div className="mr-4 mb-4 lg:ml-20 2xl:ml-64 xl:ml-36 md:mx-2 sm:ml-10 ">
              <form className=" mx-auto  ">
                ...
                <button className="rounds text-white border-white border-2  bg-black hover:bg-zinc-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium  text-sm w-full sm:w-auto px-5 py-2.5 text-center ">
                  Get a free quote →
                </button>
              </form>
            </div>
