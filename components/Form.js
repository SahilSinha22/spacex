    ...
    <div className=" bg-black ">
      ...
      <div className=" w-full h-92 ">
        <div className="  flex flex-col  ">
          <h1 className=" text-left mx-5 mt-6  sm:ml-12 md:mx-20 2xl:ml-48 2xl:mr-0  2xl:pr-60 lg:ml-28 lg:mr-20  xl:mr-60 xl:ml-48 sm:text-2xl 2xl:text-5xl items-center text-white text-lg lg:text-4xl  playfair_display">
