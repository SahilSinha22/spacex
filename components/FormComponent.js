        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className='relative z-0 w-full mb-5 group'>
            ...
            <input
              ...
              name="file"
              onChange={handleChange}
              className="py-2.5 px-0  bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:ml-20 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
            />
          </div>
          <div className='relative z-0 w-full mb-4 group'>
