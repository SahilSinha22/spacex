...
const DummyForm = () => {
    ...
    const validate = () => {
        ...
        else if (!/^\d{7,12}$/.test(user.Number.replace(/[^0-9]/g, ''))) newErrors.Number = 'Phone number must be between 7 to 12 digits';
    ...
    return (
        <div className="justify-center items-center flex overflow-x-hidden  duration-1000 overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-auto my-6 mx-auto max-w-3xl "><div className="w-full flex items-center mx-auto z-50">
          
            <form method="POST" className="space-y-4" onSubmit={getdata}>
                <div className="flex flex-col justify-center items-center w-full">
                    <div className="md:w-[650px]  bg-[#FFF] rounded-[25px]  md:h-[500px] w-[calc(100vw-10%)] md:p-10 p-[10%]  flex flex-col justify-center  ">
                        <div className="flex justify-between items-center ">
                            <div>
                                <p className=" text-[25px] font-bold ">Get in Touch </p>
                            </div>
                            <svg onClick={handleClose} className="font-bold cursor-pointer hover:red-500" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M1 1L19 19" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            </path>
                        ...
                        <div className="pt-2">
                            <div className="relative w-full min-w-[200px] h-11">
                                ...
                                <input name="Email" type="email" placeholder=" "
                                    ...
                                    className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all border-b placeholder-shown:border-blue-gray-200 text-sm pt-4 pb-1.5 border-blue-gray-200 focus:border-gray-500" />


                                <label htmlhtmlFor="Email" className="flex w-full h-full select-none pointer-events-none absolute left-0 font-normal !overflow-visible truncate peer-placeholder-shown:text-blue-gray-500 leading-tight peer-focus:leading-tight peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] after:content[''] after:block after:w-full after:absolute after:-bottom-1.5  after:border-b-2 after:scale-x-0 peer-focus:after:scale-x-100 after:transition-transform after:duration-300 peer-placeholder-shown:leading-[4.25] text-gray-500 peer-focus:text-gray-900 after:border-gray-500 peer-focus:after:border-gray-900">Email* </label>
                            </div>
                        ...
                        <div className="relative w-full pt-4">
                            ...
                            <div className="relative w-full min-w-[200px] h-11 ">
                                ...
                                <label onClick={handleFileClick} className="absolute right-2 top-4 cursor-pointer text-gray-500 peer-placeholder-shown:text-blue-gray-500 after:border-gray-500 peer-focus:after:border-gray-900">
                                    <div className=" rounded-full text-center flex justify-center items-center  h-4 w-4 bg-gradient-to-r from-[#056BA7] to-[#30B0FA] ">
                        ...
                        <div className="pt-2">
                            <div className="relative w-full min-w-[200px] h-11">
                                <input name="message" type="text" value={user.message}
                                    /// autoComplete="off"
                                    onChange={data} className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all border-b placeholder-shown:border-blue-gray-200 text-sm pt-4 pb-1.5 border-blue-gray-200 focus:border-gray-500" placeholder=" " fdprocessedid="3fkzrr" />
                                <label htmlhtmlFor="message" className="flex w-full h-full select-none pointer-events-none absolute  font-normal !overflow-visible truncate peer-placeholder-shown:text-blue-gray-500 leading-tight peer-focus:leading-tight peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] after:content[''] after:block after:w-full after:absolute after:-bottom-1.5 left-0 after:border-b-2 after:scale-x-0 peer-focus:after:scale-x-100 after:transition-transform after:duration-300 peer-placeholder-shown:leading-[4.25] text-gray-500 peer-focus:text-gray-900 after:border-gray-500 peer-focus:after:border-gray-900">Query* </label>
                            </div>
                        ...
                        <div>
                            <div className="flex flex-col  md:flex-row items-center  justify-between pt-10">
                                <div>
                                    <button type="submit" className="pl-6 pr-3   py-1 rounded-[100px]  flex items-center text-center justify-center overflow-hidden  text-[30px]   text-white bg-gradient-to-r from-[#056BA7] to-[#30B0FA] w-[200px]" fdprocessedid="qv6koe">Submit<span className="h-[52px] w-[52px] ml-4 text-black rounded-full bg-white text-center items-center flex justify-center hover:duration-1000 bg-gradient-to-r from-transparent via-transparent to-transparent hover:from-[#056BA7] hover:via-[#b0dffc] hover:to-[#30B0FA]   ">
