...
const Imgcmp = () => {
  ...
  <div className="mx-4 md:mx-8 xl:mx-36 grid  mb-10 items-center justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
    ...
    <div className="hover:bg-zinc-800   bg-black xl:w-72 2xl:w-80 h-44 px-6 rounded-xl space-y-2">
...
<div className="pt-8">
    ...
    <div className="hover:bg-zinc-800  bg-black px-6 xl:w-72 2xl:w-80 h-44 rounded-xl space-y-2">
