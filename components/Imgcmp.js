...
const Imgcmp = () => {
  return (
    <div className="mx-4 md:mx-8 xl:mx-36 grid  mb-10 items-center   justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
      <div className="hover:bg-zinc-800 imgco xl:max-w-screen-xl xl:h-44 2xl:max-h-52  2xl:h-52 lg:h-48 lg:max-h-44 bg-black  2xl:w-96 h-44 px-6  rounded-xl space-y-2">
        ...
        <div className="text-blue-300 cursor-pointer relative right-2 bottom-7  items-right">
          <Image
            className="absolute lg:-right-5 xl:-bottom-6   2xl:-bottom-10 xl:-right-4  2xl:-right-2  2xl:w-6 2xl:h-6 right-2"
            src={Arrow}
            alt="Arrow"
            width={20}
            height={5}
      ...
      <div className="hover:bg-zinc-800 imgco  xl:h-44 2xl:max-h-52 2xl:h-52  lg:h-48 lg:max-h-44 bg-black  2xl:w-96 h-44 px-6 rounded-xl space-y-2">
        <div className="text-zinc-400 mt-2 flex flex-row justify-between">
      ...
      <div className="hover:bg-zinc-800 imgco  xl:h-44 2xl:max-h-52 2xl:h-52 lg:h-48 lg:max-h-44 bg-black px-6  2xl:w-96 h-44 rounded-xl space-y-2">
        <div className="text-zinc-400 mt-2 flex flex-row justify-between">
