                ...
                <div className=" grid md:grid-cols-2 w-auto md:w-[600px] lg:w-[800px] lg:top-10 xl:top-0 xl:w-auto my-6 mx-auto justify-center place-content-center xl:max-w-4xl ">
                    <div className=' hidden md:block'>
                        <div className='relative '>
                            ...
                            <Image src="/FormImg.webp" className="-z-20 w-[300px] lg:w-[400px] xl:w-[500px] h-[550px] lg:h-[500px] xl:h-[600px]" priority alt="hey" width={500} height={300} />
                    ...
                    <div className="w-full flex  md:w-[500px]  2xl:w-[650px]   items-center ">
                        ...
                        >
                            <div className="flex flex-col  gap-10  w-full">
                                <div className="lg:w-[450px] md:w-[400px] lg:h-[500px] rounded-2xl md:rounded-none xl:w-[550px] xl:max-w-4xl h-auto bg-[#FFF]  md:h-[550px] xl:h-[600px]  2xl:w-[650px] w-[calc(100vw-10%)] px-6 lg:px-10 flex flex-col   ">
