            ...
            <div className="absolute bottom-0   xl:mx-20  2xl:mx-10  md:mx-4    lg:mx-20 xl:left-36  xl:right-36 lg:top-1 xl:top-4 top-1 left-7 right-7 mt-12  grid grid-cols-5  lg:grid-cols-5 gap-1 md:gap-2  xl:gap-3 2xl:gap-10 ">
              ...
              <div className="relative">
                <Image
                  src={Mobi11}
                  alt="App Image 2"
                  className="rounded-xl md:rounded-2xl absolute h-24 top-8 sm:h-36 sm:top-4 sm:w-44 md:h-44 md:top-8 md:w-52 lg:h-48 lg:top-16 lg:w-44 xl:h-52 xl:w-44 xl:top-11 2xl:w-72 2xl:h-68 2xl:top-20  transform hover:scale-105 transition duration-300"
                  width={100}
                  height={5}
                />
              </div>
              ...
              <div className="relative  ">
                <Image
                  src={Mobi2}
                  alt="App Image 3"
                  className="rounded-xl md:rounded-2xl absolute h-24 top-8 sm:h-36 sm:top-4 sm:w-44 md:top-8 md:h-44 md:w-52 lg:h-48 lg:w-44 lg:top-16 xl:h-52 xl:w-52 xl:top-11 2xl:w-72 2xl:h-68 2xl:top-20    transform hover:scale-105 transition duration-300"
                  width={100}
                  height={5}
                />
              </div>
              <div className="relative">
                <Image
                  src={Mobi22}
                  alt="App Image 4"
                  className="rounded-xl md:rounded-2xl  absolute h-32 sm:h-52 sm:-top-10 sm:w-44 md:w-52 md:-top-7 md:h-60  lg:h-72 lg:-top-7 lg:w-44 xl:h-72  xl:w-72 xl:-top-8 2xl:w-72 2xl:h-80 2xl:-top-8    transform hover:scale-105 transition duration-300"
                  width={100}
                  height={5}
                />
              </div>
