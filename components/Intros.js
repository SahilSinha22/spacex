...
const Intros = () => {
  ...
  return (
    ...
    <div
      className="intros text-white  h-auto  "
    ...
    >
     ...
     <div className="md:px-10 xl:px-40 flex bg-black items-center  justify-between flex-wrap ">
      ...
      <div className="  flex items-center flex-shrink-0 text-white mr-5 ml-8 xl:ml-8 2xl:ml-8 xl:mr-20 2xl:mr-40 lg:mr-20">
        <span>
          <Image src={Logo} className="sm:w-60 lg:w-44 lg:h-7 sm:h-10" alt="Logo" width={200} height={10} />
        </span>
      </div>
    ...
    <div className="pt-12">
      ...
      <div className=" relative   h-24 md:h-10 -top-10   sm:h-32 lg:h-52 xl:h-52 2xl:h-56 ">
        <div className="absolute bottom-0   xl:mx-20  2xl:mx-10 md:mx-4    lg:mx-20 xl:left-36  xl:right-36 lg:top-1 xl:top-4 top-1 left-7 right-7 mt-12  grid grid-cols-5  lg:grid-cols-5 gap-1 md:gap-2 2xl:gap-5 ">
      ...
      <div className="grid logos gap-3 md:mx-16 mx-8 lg:px-12 grid-cols-4 h-20 xl:mx-44 2xl:mx-40 2xl:px-0 sm:h-32  sm:grid-cols-4  md:flex mt-5 justify-center md:justify-around  md:space-x-4 md:mt-40 lg:mt-8 lg:h-40 md:h-32 xl:h-48">
        <div className=""
>
        <Image 
          src={Mobi3}
          alt="Company Logo 1"
          className="grow  md:h-10   lg:w-40 sm:w-28 lg:mt-20 xl:w-40 xl:h-12 md:w-36 md:mx-2 mt-10 sm:mt-1 xl:mt-24  md:mt-16  md:pt-0 sm:pt-5  hover:opacity-100 transition duration-300  hover:scale-110"
          width={60}
          height={5}
        />
        </div>
        ...
        <Image
          src={Mobi4}
          alt="Company Logo 2"
          className="grow md:h-10   lg:w-40 xl:w-40 lg:mt-20 sm:w-28 xl:h-12 md:w-36 md:mx-2 mt-10 sm:mt-1 xl:mt-[102px] md:mt-16  md:pt-0 sm:pt-5  hover:opacity-100 transition duration-300 hover:scale-105"
          width={60}
          height={5}
        />
        </div>
        ...
        <Image
          src={Mobi5}
          alt="Company Logo 3"
          className="grow md:h-10  lg:w-40 xl:w-48  lg:mt-20 sm:w-32 xl:h-16 md:w-36 md:mx-2 mt-10 sm:mt-0 xl:mt-24 md:mt-16  md:pt-0 sm:pt-5  hover:opacity-100 transition duration-300 hover:scale-105"
          width={60}
          height={5}
        />
        </div>
        ...
        <Image
          src={Mobi6}
          alt="Company Logo 4"
          className="grow md:h-10   lg:w-40 xl:w-40 lg:mt-20 sm:w-32 xl:h-16 md:w-36 md:mx-2 mt-10 sm:mt-0 xl:mt-24 md:mt-16  md:pt-0 sm:pt-5  hover:opacity-100 transition duration-300 hover:scale-105"
          width={60}
          height={5}
        />
        </div>
