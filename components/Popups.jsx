...
const DumyForm = ({ onClose }) => {
    ...
    return (
        ...
        <div class="sm:justify-center px-4 sm:px-0 Glassy   items-center flex m-auto w-full    overflow-y-auto fixed inset-0 z-50 ">
            ...
            <div class="  flex w-auto md:w-[600px] lg:w-[800px]  lg:top-10 xl:top-0 xl:w-auto my-6  md:justify-center place-content-center xl:max-w-4xl 2xl:max-w-7xl">
                <div className=' hidden sm:block'>
                    <div className='relative '>
                        ...
                        <Image src="/FormImg.webp" className="-z-20 w-[300px] md:w-[400px] lg:w-[450px] xl:w-[500px] h-[490px]  md:h-[500px] xl:h-[600px] 2xl:h-[650px]" alt="" width={1000} height={1000} />
