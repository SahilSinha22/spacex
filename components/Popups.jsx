            ...
            <div class="  flex w-auto md:w-[600px] lg:w-[800px]   xl:w-auto my-6 mx-auto md:justify-center place-content-center xl:max-w-4xl 2xl:max-w-7xl">
                <div className=' hidden md:block'>
                    <div className='relative '>
                        ...
                        <Image src="/FormImg.webp" className="-z-20 w-[400px] lg:w-[450px] xl:w-[500px] h-[500px] xl:h-[600px] 2xl:h-[650px]" alt="" width={1000} height={1000} />
                    ...
                    >
                        <div class="flex flex-col  gap-10 rounded-4xl md:rounded-none w-full">
                            <div class="lg:w-[450px] md:w-[350px] xl:w-[550px] rounded-xl md:rounded-none xl:max-w-4xl h-auto bg-[#FFF]  md:h-[500px] xl:h-[600px] 2xl:h-[650px] 2xl:w-[550px] w-[calc(100vw-10%)] px-6 lg:px-10 flex flex-col   ">
                                ...
                                <button
                                    onClick={getdata}
                                    className="rounded-full rounds t-4 text-white border-white border-2 bannerx focus:ring-4 focus:outline-none focus:ring-blue-300 open_sans_display  xl:text-lg w-full sm:w-auto xl:px-8 xl:py-3 px-4 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    type="submit"
                                    style={{
                                ...
                                <h2 className='text-[#000000] z-20 text-xs md:text-xs lg:text-base xl:text-lg open_sans_display '>In Just <b> 10 min</b> You Will Get A Response</h2>
