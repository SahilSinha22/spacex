...
const Footer = () => {
  return (
    <footer classNameName=" w-auto  md:mb-10  items-center justify-center flex flex-col  w-full flex    text-white  text-xs">
      <div className=" bg-black  flex-col sm:flex-row 2xl:justify-around   xl:justify-between     xl:text-xl 2xl:text-2xl   grid grid-cols-3  sm:gap-6  sm:justify-between sm:gap-y-10 lg:grid-cols-4  md:flex md:justify-between   py-5  text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
        <ul
        ...
        <ul className="xl:text-xl 2xl:text-2xl  mb-4 justify-around space-y-4 md:mb-0">
            <h1 className="xl:text-3xl 2xl:text-4xl  text-white py-2 sm:py-4 font-bold  text-lg sm:text-xl"> Services</h1>
        ...
        <ul className="mb-4 space-y-4  md:mb-0">
            <h1 className="xl:text-3xl 2xl:text-4xl text-white px-4 py-4 font-bold text-xl sm:text-2xl">Expertise</h1>
          <li className="xl:text-xl 2xl:text-2xl   text-sm sm:text-lg">
            <a
              href="#"
              className="xl:text-xl 2xl:text-2xl  hover:underline hover:text-white dark:hover:text-blue-500"
    ...
    <ul className=' bg-zinc-700  xl:text-xl 2xl:text-2xl  flex flex-row  px-4  space-x-11  text-zinc-500 border-2xl justify-center   text-center  text-xl '>
